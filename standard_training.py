...
parser.add_argument('--model_dir', default='./rst_standard',
...
parser.add_argument('--loss', default='trades', type=str,
                    choices=('trades', 'noise', 'trades_non_adv'),
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        train_data = train(args, model, device, eval_train_loader, optimizer, epoch)
